    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md text-center">
        ...
        <p className="text-slate-600 mb-8">
          Olá, <span className="font-semibold">{user?.user_metadata?.full_name || user?.email}</span>. Sua solicitação de acesso foi recebida e está aguardando a aprovação de um administrador.
        </p>

        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm mb-8 text-left">
          <div className="flex<div className="flex gap-3 items-start">
